...
if($input -> get('do') == 'check'){
    ...
    /*如果row确实返回了结果，则将结果的userid存储在session里，并转向user_home.php文件*/
    if(is_array($row)){
    ...
    <div class = "row" style = "margin-top:200px;">
        ...
        <div class = "panel panel-primary">
            ...
            <div class = "panel-body">
                <form  class = "form-horizontal" action = "user_login.php?do=check" method = "post">

                    <!--登录的用户名那一行></!-->
                    <div class = "form-group">
                        <label for = "inputEmail3" class = "col-sm-2 control-label">用户名</label>
                        <div class = "col-sm-9">
                            <input type = "text" class = "form-control" name = "username" id = "username" placeholder = "请输入用户名" datatype = "*3-10" errormsg = "请输入长度 范围在3-10之间的昵称">
                        </div>
                    </div>
